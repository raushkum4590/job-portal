        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              JobForge is your career catalyst, connecting talented professionals with amazing opportunities. 
              We're revolutionizing the job search experience with AI-powered matching and personalized career guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/jobs" className="text-gray-300 hover:text-white transition-colors duration-200 flex items-center">
                  <BriefcaseIcon className="w-4 h-4 mr-2" />
                  Browse Jobs
                </Link>
              </li>
              <li>
                <Link href="/hire" className="text-gray-300 hover:text-white transition-colors duration-200 flex items-center">
